...
/* callback */
typedef unsigned long (plugin_event_handler_t) (plugin_user_t *, void *, unsigned long event, buffer_t *token);
...
extern plugin_user_t	*plugin_robot_add (unsigned char *name, unsigned char *description, plugin_event_handler_t *);
extern int		 plugin_robot_remove (plugin_user_t *);
extern plugin_event_handler_t * plugin_robot_set_handler (plugin_user_t *robot, plugin_event_handler_t *handler);
...
extern unsigned int plugin_user_banip (plugin_user_t *user, buffer_t *message, unsigned long period);
extern unsigned int plugin_user_banip_hard (plugin_user_t *user, buffer_t *message, unsigned long period);
extern unsigned int plugin_user_bannick (plugin_user_t *user, buffer_t *message, unsigned long period);
extern unsigned int plugin_user_ban (plugin_user_t *user, buffer_t *message, unsigned long period);
...
extern unsigned int plugin_user_sayto (plugin_user_t *src, plugin_user_t *target, buffer_t *message);
extern unsigned int plugin_user_priv (plugin_user_t *src, plugin_user_t *target, plugin_user_t *source, buffer_t *message, int direct);
...
extern unsigned int plugin_user_forcemove (plugin_user_t *user, unsigned char *destination, buffer_t *message);
